 ...
 */
public class FreeListAdapter extends AnimRFRecyclerView.Adapter<FreeListAdapter.MyViewHolder>
{
    private Context context;
    private List<FreeApply> freeApplies;
    public FreeListAdapter(Context context,List<FreeApply> freeApplies) {
